...
>>>>>>> 582fde2423874e0e4e8b15278ac8d4109e4d641e
...
fit=lm(danceability ~ liveness + energy, data=tr_dat)
predicts=predict(fit, te_dat)
actual=te_dat$danceability

rng=range(c(predicts,actual))
plot(actual ~ predicts, pch=20, xlim=rng, ylim=rng, main="Predicted Danceablity Vs. Actual")
