...
par(mfrow=c(2,2))
plot(density(dat$danceability),col="red",main="Density of Features",ylim=c(0,.04))
...
cat("\nTotss of fit: ",fit2$totss)
cat("\nBetweenss/Totss", (fit2$betweenss/fit2$totss))
...
cat("\nBetweenss of fit: ",fit3$betweenss)
cat("\nTotss of fit: ",fit3$totss)
cat("\nBetweenss/Totss", (fit3$betweenss/fit3$totss))

sil2=silhouette(fit3$cluster,dist(te_dat))
cat("\nSilhouette Width",mean(sil2[,3]))
