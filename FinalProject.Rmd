...
plot(tempo ~ speechiness, main = "Tempo vs. Speechness", data = dat)
plot(dat)

plot(energy~loudness, main = "Energy vs. Loudness", data = dat)
plot(acousticness~loudness, main = "Acousticness vs. Loudness", data = dat)
plot(density(dat$energy), main = "Distribution of Energy")
```
